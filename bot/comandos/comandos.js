export function comandosInfo(botInfo){
    ...
    const comandos = {
        ...
        downloads: {
            dl: {
                descricao: '',
                guia: `Ex: *${prefixo}dl* musica - Faz download de uma música do Youtube e envia como audio.\n`,
                msgs: {
                    espera: "꧁🍀🥰😈 *Տᗴ᙭ ᒪOᐯᗴ* 😈🥰🍀꧂ \n \n 🎶✨ *Pedido recebido!* ✨🎶 \n \n Alguém pediu uma vibe especial aqui! 🎧💥 Estou preparando sua música, só mais um instante ⏳ \n \n 💫🎉 ₊˚🖇️✩ ₊˚🎧⊹♡ *Տᗴ᙭ ᒪOᐯᗴ* ·❆· ※───  *O som tá chegando pra animar!* 🌹💃🕺. \n\n"+
                    "Titulo: *{p1}*\n"+
                    "Duração: *{p2}*",
            ...
            yt: {
                ...
                msgs: {
                    espera: "꧁🎥💖🔥 *Տᗴ᙭ ᒪOᐯᗴ* 🔥💖🎥꧂ \n \n  🎬✨ Pedido recebido! ✨🎬 \n \n Alguém pediu um vídeo especial aqui! 🎥💥 Estou preparando seu vídeo, só mais um instante ⏳  \n \n  🌟🎉 ₊˚📎✩ ₊˚🎞️⊹♡ Տᗴ᙭ ᒪOᐯᗴ ·❆· ※─── O vídeo tá chegando pra animar! 🌹💃🕺. \n\n"+
                    "Titulo: *{p1}*\n"+
                    "Duração: *{p2}*",
            ...
            fb: {
                ...
                msgs: {
                    espera: "꧁🎥💖🔥 *Տᗴ᙭ ᒪOᐯᗴ* 🔥💖🎥꧂ \n \n 🎬✨ Pedido recebido! ✨🎬 \n \n O download da sua mídia do facebook já começou! 🎥💥 Só mais um instante enquanto preparamos tudo pra você ⏳ \n \n 🌟🎉 ₊˚📎✩ ₊˚🎞️⊹♡ Տᗴ᙭ ᒪOᐯᗴ ·❆· ※─── A mídia tá chegando pra animar! 🌹💃🕺. \n\n"+
                    "Titulo: *{p1}*\n"+
                    "Duração: *{p2}*",
            ...
            ig: {
                ...
                msgs: {
                    espera: "꧁🎥💖🔥 *Տᗴ᙭ ᒪOᐯᗴ* 🔥💖🎥꧂ \n \n 🎬✨ Pedido recebido! ✨🎬 \n \n O download da sua mídia do instagram já começou! 🎥💥 Só mais um instante enquanto preparamos tudo pra você ⏳ \n \n 🌟🎉 ₊˚📎✩ ₊˚🎞️⊹♡ Տᗴ᙭ ᒪOᐯᗴ ·❆· ※─── A mídia tá chegando pra animar! 🌹💃🕺.",
                }
            },
            tw: {
                descricao: '',
                ...
                msgs: {
                    espera: "꧁🎥💖🔥 *Տᗴ᙭ ᒪOᐯᗴ* 🔥💖🎥꧂ \n \n 🎬✨ Pedido recebido! ✨🎬 \n \n O download da sua mídia do Twitter já começou! 🎥💥 Só mais um instante enquanto preparamos tudo pra você ⏳ \n \n 🌟🎉 ₊˚📎✩ ₊˚🎞️⊹♡ Տᗴ᙭ ᒪOᐯᗴ ·❆· ※─── A mídia tá chegando pra animar! 🌹💃🕺.",
                }
            },
            tk: {
                descricao: '',
                ...
                msgs: {
                    espera: "꧁🎥💖🔥 *Տᗴ᙭ ᒪOᐯᗴ* 🔥💖🎥꧂ \n \n 🎬✨ Pedido recebido! ✨🎬 \n \n O download da sua mídia do Tiktok já começou! 🎥💥 Só mais um instante enquanto preparamos tudo pra você ⏳ \n \n 🌟🎉 ₊˚📎✩ ₊˚🎞️⊹♡ Տᗴ᙭ ᒪOᐯᗴ ·❆· ※─── A mídia tá chegando pra animar! 🌹💃🕺. \n\n"+
                    "Perfil: *@{p1}*\n"+
                    "Descrição: *{p2}*\n",
                }
            },
        ...
        grupo: {
            ...
            addl: {
                descricao: '',
                guia: `Ex: Responda alguém com *${prefixo}addl* - Adiciona o numero de quem foi respondido a lista negra e bane em seguida.\n\n`+
                `Ex: Marque alguém com *${prefixo}addl* - Adiciona o numero de quem foi marcado a lista negra e bane em seguida.\n\n`+
                `Ex: *${prefixo}addl* +55219xxxx-xxxx - Adiciona o número digitado a lista negra do grupo e bane em seguida.\n.`,
                msgs: {
                    sucesso: "✅ *USUÁRIO ADICIONADO À LISTA NEGRA DO GRUPO* ꧁🍀🥰😈 *Տᗴ᙭ ᒪOᐯᗴ* 😈🥰🍀꧂ \n \n Agora você está sob observação… *Não pense que escapou!* 👁️⚡🕷️",
                    ...
                    ja_listado: "⚠️ *Este usuário já faz parte da lista negra do grupo* ꧁🍀🥰😈 *Տᗴ᙭ ᒪOᐯᗴ* 😈🥰🍀꧂ \n \n *Nada passa despercebido por aqui…* 👁️🕷️",
                }
            },
            rnl: {
                descricao: '',
                guia: `Ex: *${prefixo}rnl* +55219xxxx-xxxx - Remove o número digitado da lista negra do grupo.\n`,
                msgs: {
                    sucesso: "✅ *USUÁRIO REMOVIDO DA LISTA NEGRA DO GRUPO* \n \n ꧁🍀🥰😈 *Տᗴ᙭ ᒪOᐯᗴ* 😈🥰🍀꧂\n \n Agora liberado para brincar no grupo… *mas não se esqueça, as regras são fortes!* ⚡🎯",
                    nao_listado: "⚠️ USUÁRIO NÃO LOCALIZADO NA 🚫 LISTA NEGRA DO GRUPO \n \n ꧁🍀🥰😈 *Տᗴ᙭ ᒪOᐯᗴ* 😈🥰🍀꧂ \n \n Parece que está limpo por enquanto... *mas fique atento!* 👀⚡",
                }
            },
            listanegra: {
                descricao: '',
                ...
                msgs: {
                    ...
                    lista_vazia: "💀 No grupo ꧁🍀🥰😈 *Տᗴ᙭ ᒪOᐯᗴ* 😈🥰🍀꧂, a lista negra se esconde nas trevas... 🌑 *Aguardando pacientemente pelos próximos intrusos…* 🕷️👁️",
            ...
            mti: {
                descricao: '',
                guia: `Ex: *${prefixo}mti* 5 - Marca todos os membros com menos de 5 mensagens.\n\n`+
                `*Obs*: Este comando só funciona com o *${prefixo}contador* ativado.\n`,
                msgs: {
            ...
            bcmd: {
                descricao: '',
                guia: `Ex: *${prefixo}bcmd* ${prefixo}s ${prefixo}sgif ${prefixo}dl - Bloqueia no grupo os comandos ${prefixo}s, ${prefixo}sgif e ${prefixo}dl (você pode escolher os comandos a sua necessidade).\n\n`+
            ...
            dcmd: {
                descricao: '',
                guia: `Ex: *${prefixo}dcmd* ${prefixo}s ${prefixo}sgif ${prefixo}dl - Desbloqueia no grupo os comandos ${prefixo}s, ${prefixo}sgif e ${prefixo}dl.\n\n`+
        ...
        admin: {
            ...
            bcmdglobal: {
                descricao: '',
                guia: `Ex: *${prefixo}bcmdglobal* ${prefixo}s ${prefixo}sgif ${prefixo}dl - Bloqueia  os comandos ${prefixo}s, ${prefixo}sgif e ${prefixo}dl (você pode escolher os comandos a sua necessidade).\n\n`+
            ...
            dcmdglobal: {
                descricao: '',
                guia: `Ex: *${prefixo}dcmdglobal* ${prefixo}s ${prefixo}sgif ${prefixo}dl - Desbloqueia  os comandos ${prefixo}s, ${prefixo}sgif e ${prefixo}dl.\n\n`+
